...
def update_display_data():
    ...
    try:
        conn_1 = pymysql.connect(host="localhost", user="housys", password="housys", database="housys")
        y = conn_1.cursor()
...
while True:
    try:
        conn = pymysql.connect(host="localhost", user="housys", password="housys", database="housys")
        x = conn.cursor()
        ser_com5=1
        ser_com6=1
...
checkbox2 = tk.Checkbutton(root, text="Bay 1B", font=bold_font,variable=checkbox_var2,command=lambda: on_checkbox_checked(checkbox_var2, "ID1", "WELCOME"))
checkbox2.pack()
checkbox2.place(x=220, y=170)
checkbox_var3 = tk.BooleanVar()
checkbox3 = tk.Checkbutton(root, text="Bay 2A",font=bold_font, variable=checkbox_var3,command=lambda: on_checkbox_checked(checkbox_var3, "ID2", "WELCOME"))
checkbox3.pack()
checkbox3.place(x=220, y=230)
# checkbox_var4 = tk.BooleanVar()
# checkbox4 = tk.Checkbutton(root, text="Display 1D",font=bold_font, variable=checkbox_var4,command=lambda: on_checkbox_checked(checkbox_var4, "ID2", "WELCOME"))
# checkbox4.pack()
# checkbox4.place(x=90, y=210)
# checkbox_var5 = tk.BooleanVar()
# checkbox5 = tk.Checkbutton(root, text="Display 1E",font=bold_font, variable=checkbox_var5,command=lambda: on_checkbox_checked(checkbox_var5, "ID2", "WELCOME"))
# checkbox5.pack()
# checkbox5.place(x=90, y=250)
# checkbox_var6 = tk.BooleanVar()
# checkbox6 = tk.Checkbutton(root, text="Display 2A",font=bold_font, variable=checkbox_var6,command=lambda: on_checkbox_checked(checkbox_var6, "ID5", "WELCOME"))
# checkbox6.pack()
# checkbox6.place(x=90, y=290)
# checkbox_var7 = tk.BooleanVar()
# checkbox7 = tk.Checkbutton(root, text="Display 2B",font=bold_font, variable=checkbox_var7,command=lambda: on_checkbox_checked(checkbox_var7, "ID5", "WELCOME"))
# checkbox7.pack()
# checkbox7.place(x=90, y=330)
# checkbox_var8 = tk.BooleanVar()
# checkbox8 = tk.Checkbutton(root, text="Display 2C",font=bold_font, variable=checkbox_var8,command=lambda: on_checkbox_checked(checkbox_var8, "ID6", "WELCOME"))
# checkbox8.pack()
# checkbox8.place(x=90, y=370)
# checkbox_var9 = tk.BooleanVar()
# checkbox9 = tk.Checkbutton(root, text="Display 3A", font=bold_font, variable=checkbox_var9,command=lambda: on_checkbox_checked(checkbox_var9, "ID3", "WELCOME"))
# checkbox9.pack()
# checkbox9.place(x=90, y=410)
# checkbox_var10 = tk.BooleanVar()
# checkbox10 = tk.Checkbutton(root, text="Display 3B",font=bold_font, variable=checkbox_var10,command=lambda: on_checkbox_checked(checkbox_var10, "ID3", "WELCOME"))
# checkbox10.pack()
# checkbox10.place(x=90, y=450)
# checkbox_var10 = tk.BooleanVar()
...
checkbox12 = tk.Checkbutton(root, text="Bay 3A",font=bold_font, variable=checkbox_var12,command=lambda: on_checkbox_checked(checkbox_var12, "ID4", "WELCOME"))
checkbox12.pack()
checkbox12.place(x=520, y=170)
checkbox_var13 = tk.BooleanVar()
checkbox13 = tk.Checkbutton(root, text="Bay 3B", font=bold_font,variable=checkbox_var13,command=lambda: on_checkbox_checked(checkbox_var13, "ID9", "WELCOME"))
checkbox13.pack()
checkbox13.place(x=520, y=220)
checkbox_var14 = tk.BooleanVar()
checkbox14 = tk.Checkbutton(root, text="Bay 4A", font=bold_font,variable=checkbox_var14,command=lambda: on_checkbox_checked(checkbox_var14, "ID9", "WELCOME"))
checkbox14.pack()
checkbox14.place(x=860, y=110)
checkbox_var15 = tk.BooleanVar()

checkbox15 = tk.Checkbutton(root, text="Bay 4B", font=bold_font,variable=checkbox_var15,command=lambda: on_checkbox_checked(checkbox_var15, "ID10", "WELCOME"))
checkbox15.pack()
checkbox15.place(x=860, y=170)

checkbox_var16 = tk.BooleanVar()

checkbox16 = tk.Checkbutton(root, text="Bay 5A", font=bold_font,variable=checkbox_var15,command=lambda: on_checkbox_checked(checkbox_var15, "ID10", "WELCOME"))
checkbox16.pack()
...
# checkbox19 = tk.Checkbutton(root, text="", font=bold_font,variable=checkbox_var19,command=lambda: on_checkbox_checked(checkbox_var19, "ID7", "WELCOME"))
# checkbox19.pack()
# checkbox19.place(x=290, y=370)
# checkbox_var20 = tk.BooleanVar()

# checkbox20 = tk.Checkbutton(root, text="Display 5C",font=bold_font, variable=checkbox_var20,command=lambda: on_checkbox_checked(checkbox_var20, "ID8", "WELCOME"))
# checkbox20.pack()
# checkbox20.place(x=290, y=410)
# checkbox20 = tk.Checkbutton(root, text="Display 5D",font=bold_font, variable=checkbox_var20,command=lambda: on_checkbox_checked(checkbox_var20, "ID8", "WELCOME"))
# checkbox20.pack()
# checkbox20.place(x=290, y=450)
...
checkbox_var2 = tk.BooleanVar()
checkbox2 = tk.Checkbutton(root, text=" Bay 1B", font=bold_font,variable=checkbox_var2,command=lambda: on_checkbox_checked1(checkbox_var2, "ID1", "MAINTENANCE"))
checkbox2.pack()
checkbox2.place(x=220, y=430)
checkbox_var3 = tk.BooleanVar()
checkbox3 = tk.Checkbutton(root, text="Bay 2A", font=bold_font,variable=checkbox_var3,command=lambda: on_checkbox_checked1(checkbox_var3, "ID2", "MAINTENANCE"))
checkbox3.pack()
checkbox3.place(x=220, y=490)
checkbox_var4 = tk.BooleanVar()
checkbox4 = tk.Checkbutton(root, text="Bay 2B", font=bold_font,variable=checkbox_var4,command=lambda: on_checkbox_checked1(checkbox_var4, "ID2", "MAINTENANCE"))
checkbox4.pack()
checkbox4.place(x=520, y=370)
checkbox_var5 = tk.BooleanVar()
checkbox5 = tk.Checkbutton(root, text="Bay 3A", font=bold_font,variable=checkbox_var5,command=lambda: on_checkbox_checked1(checkbox_var5, "ID2", "MAINTENANCE"))
checkbox5.pack()
checkbox5.place(x=520, y=430)
checkbox_var6 = tk.BooleanVar()
checkbox6 = tk.Checkbutton(root, text="Bay 3B",font=bold_font, variable=checkbox_var6,command=lambda: on_checkbox_checked1(checkbox_var6, "ID5", "MAINTENANCE"))
checkbox6.pack()
checkbox6.place(x=520, y=490)
checkbox_var7 = tk.BooleanVar()
checkbox7 = tk.Checkbutton(root, text="Bay 4A",font=bold_font, variable=checkbox_var7,command=lambda: on_checkbox_checked1(checkbox_var7, "ID5", "MAINTENANCE"))
checkbox7.pack()
checkbox7.place(x=860, y=370)
checkbox_var8 = tk.BooleanVar()
checkbox8 = tk.Checkbutton(root, text="Bay 4B",font=bold_font, variable=checkbox_var8,command=lambda: on_checkbox_checked1(checkbox_var8, "ID6", "MAINTENANCE"))
checkbox8.pack()
checkbox8.place(x=860, y=430)
checkbox_var9 = tk.BooleanVar()
checkbox9 = tk.Checkbutton(root, text="Bay 5A",font=bold_font, variable=checkbox_var9,command=lambda: on_checkbox_checked1(checkbox_var9, "ID3", "MAINTENANCE"))
checkbox9.pack()
checkbox9.place(x=860, y=490)
checkbox_var10 = tk.BooleanVar()
checkbox10 = tk.Checkbutton(root, text="Bay 5B",font=bold_font, variable=checkbox_var10,command=lambda: on_checkbox_checked1(checkbox_var10, "ID3", "MAINTENANCE"))
checkbox10.pack()
checkbox10.place(x=1100, y=430)


# checkbox11 = tk.Checkbutton(root, text="Displa 3C", font=bold_font,variable=checkbox_var11,command=lambda: on_checkbox_checked1(checkbox_var11, "ID4", "MAINTENANCE"))
# checkbox11.pack()
# checkbox11.place(x=720, y=90)
# checkbox_var12 = tk.BooleanVar()
# checkbox12 = tk.Checkbutton(root, text="Display 3D",font=bold_font, variable=checkbox_var12,command=lambda: on_checkbox_checked1(checkbox_var12, "ID4", "MAINTENANCE"))
# checkbox12.pack()
# checkbox12.place(x=720, y=130)
# checkbox_var13 = tk.BooleanVar()
# checkbox13 = tk.Checkbutton(root, text="Display 4A", font=bold_font,variable=checkbox_var13,command=lambda: on_checkbox_checked1(checkbox_var13, "ID9", "MAINTENANCE"))
# checkbox13.pack()
# checkbox13.place(x=720, y=170)
# checkbox_var14 = tk.BooleanVar()
# checkbox14 = tk.Checkbutton(root, text="Display 4B", font=bold_font,variable=checkbox_var14,command=lambda: on_checkbox_checked1(checkbox_var14, "ID9", "MAINTENANCE"))
# checkbox14.pack()
# checkbox14.place(x=720, y=210)
# checkbox_var15 = tk.BooleanVar()

# checkbox15 = tk.Checkbutton(root, text="Display 4C", font=bold_font,variable=checkbox_var15,command=lambda: on_checkbox_checked1(checkbox_var15, "ID10", "MAINTENANCE"))
# checkbox15.pack()
# checkbox15.place(x=720, y=250)
# checkbox_var16 = tk.BooleanVar()



# checkbox17 = tk.Checkbutton(root, text="Display 4D",font=bold_font, variable=checkbox_var17,command=lambda: on_checkbox_checked1(checkbox_var17, "ID10", "MAINTENANCE"))
# checkbox17.pack()
# checkbox17.place(x=720, y=290)
# checkbox_var18 = tk.BooleanVar()

# checkbox18 = tk.Checkbutton(root, text="Display 5A",font=bold_font, variable=checkbox_var18,command=lambda: on_checkbox_checked1(checkbox_var18, "ID7", "MAINTENANCE"))
# checkbox18.pack()
# checkbox18.place(x=720, y=330)
# checkbox_var19 = tk.BooleanVar()

# checkbox19 = tk.Checkbutton(root, text="Display 5B", font=bold_font,variable=checkbox_var19,command=lambda: on_checkbox_checked1(checkbox_var19, "ID7", "MAINTENANCE"))
# checkbox19.pack()
# checkbox19.place(x=720, y=370)
# checkbox_var20 = tk.BooleanVar()

# checkbox20 = tk.Checkbutton(root, text="Display 5C",font=bold_font, variable=checkbox_var20,command=lambda: on_checkbox_checked1(checkbox_var20, "ID8", "MAINTENANCE"))
# checkbox20.pack()
# checkbox20.place(x=720, y=410)
# checkbox20 = tk.Checkbutton(root, text="Display 5D",font=bold_font, variable=checkbox_var20,command=lambda: on_checkbox_checked1(checkbox_var20, "ID8", "MAINTENANCE"))
# checkbox20.pack()
# checkbox20.place(x=720, y=450)
